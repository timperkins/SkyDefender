...
struct ColliderType: OptionSetType, Hashable, CustomDebugStringConvertible {
    ...
    static var Background: ColliderType  { return self.init(rawValue: 1 << 0) }
    static var Plane: ColliderType { return self.init(rawValue: 1 << 1) }
    static var Missle: ColliderType   { return self.init(rawValue: 1 << 2) }
    ...
    var debugDescription: String {
        ...
        case ColliderType.Background.rawValue:
            return "ColliderType.Background"
            
        case ColliderType.Plane.rawValue:
            return "ColliderType.Plane"
            
        case ColliderType.Missle.rawValue:
